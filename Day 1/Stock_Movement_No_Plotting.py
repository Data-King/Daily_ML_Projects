...
print("Created technical indicators (SMA/EMA, MACD, RSI, Bollinger Bands, Volume, Momentum, Volatility)")
...
print("Target variable: Binary (0=Down, 1=Up)")
...
for i, (date, pred, proba) in enumerate(zip(recent_dates, predictions, probabilities)):
    ...
    correct = "OK" if pred == y_test.iloc[-(5 - i)] else "X"
...
# ============================================================================
# STEP 11: TRADING SIMULATION (NO PLOTTING)
# ============================================================================
print("\n" + "="*70)
print("[STEP 11] Backtesting Trading Strategy (Text-only)...")
